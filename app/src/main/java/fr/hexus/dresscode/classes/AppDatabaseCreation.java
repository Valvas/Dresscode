...
public class AppDatabaseCreation extends SQLiteOpenHelper
{
    ...
    {
        String wardrobeTable = "CREATE TABLE " + Constants.WARDROBE_TABLE_NAME + " (id INTEGER PRIMARY KEY, " + Constants.WARDROBE_TABLE_COLUMNS_TYPE + " INTEGER NOT NULL, " + Constants.WARDROBE_TABLE_COLUMNS_PATH + " TEXT NOT NULL, " + Constants.WARDROBE_TABLE_COLUMNS_OUTFIT + " INTEGER, " + Constants.WARDROBE_TABLE_COLUMNS_UUID + " TEXT)";
