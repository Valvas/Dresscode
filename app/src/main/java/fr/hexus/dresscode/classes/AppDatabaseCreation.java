...
public class AppDatabaseCreation extends SQLiteOpenHelper
{
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        String outfitElementsTable = "CREATE TABLE " + Constants.OUTFIT_ELEMENTS_TABLE_NAME + " (id, INTEGER PRIMARY KEY, " + Constants.OUTFIT_ELEMENTS_TABLE_COLUMNS_OUTFIT_UUID + " TEXT NOT NULL, " + Constants.OUTFIT_ELEMENTS_TABLE_COLUMNS_ELEMENT_UUID + " TEXT NOT NULL)";
